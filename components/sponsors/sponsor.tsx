...
interface Sponsor {
  ...
  logoUrl: string;
  bannerUrl: string | null;   // Cambiado de string | undefined a string | null
  websiteUrl: string | null;  // Cambiado de string | undefined a string | null
  affiliateCode: string | null; // Cambiado de string | undefined a string | null
  affiliateUrl: string | null;  // Cambiado de string | undefined a string | null
...
interface SponsorBannerProps {
  ...
  showPlatformSponsors?: boolean;
}

export const SponsorBanner = ({
  sponsors,
  variant = "sidebar",
  showPlatformSponsors = true,
}: SponsorBannerProps) => {
  ...
  // VARIANTE SIDEBAR - Banner vertical rotativo
  if (variant === "sidebar") {
  ...
  // VARIANTE HORIZONTAL - Logos en fila
  ...
  // VARIANTE GRID - Cards en cuadrícula
  if (variant === "grid") {
    return (
